...
function createMap(){
    ...
    var darkTerrain = L.tileLayer(mbStyleUrl, {id: 'cory-walter/ckhmt0eh9077r19luge8ms28o', token: apitoken,  attribution: mbAttr});   
    ...
    //create the map*/
    var map = L.map('map', {
        center: [47.152, -122.578],//Coordinated to center the map
        zoom: 6, //zoom level
